...
let rec countBySlidingSumIncrease: CountByIncrease =
    fun acc list ->
        ...
        | x :: y :: z :: d :: rest when x + y + z < y + z + d -> countBySlidingSumIncrease (acc + 1) (y :: z :: d :: rest)
        | _ -> failwith "absurd case"
...
let main argv =
    ...
    let (answer, _) =
        File.ReadAllLines("/Users/calebbarde/RiderProjects/AdventOfCode2021/Day1/Day1.txt")
        |> Seq.toList
        |> List.map int
